...
class InfoMessage:
    ...
    def get_message(self):
        return (f'Тип тренировки:{self.training_types}; '
...
class Training:
    ...
    def get_distance(self) -> float:
        ...
        return f'{(self.action * self.LEN_STEP) / self.M_IN_KM}'

    def get_mean_speed(self) -> float:
        """Получить среднюю скорость движения."""
        return f'{self.get_distance() / self.duration}'
...
def read_package(workout_type: str, data: list) -> Training:
    ...
    return workout_type[workout_types](*data)
